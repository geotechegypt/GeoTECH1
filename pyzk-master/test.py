...
class PYZKTest(unittest.TestCase):
    ...
    def test_no_ping(self,helper, socket):
        ...
        #begin
        zk = ZK('geotecheg.hopto.org')
        helper.assert_called_with('geotecheg.hopto.org', 4370) # called correctly
    ...
    def test_correct_ping(self,helper, socket):
        ...
        #begin
        zk = ZK('geotecheg.hopto.org', force_udp=True)
        helper.assert_called_with('geotecheg.hopto.org', 4370) # called correctly
    ...
    def test_tcp_connect(self, helper, socket):
        ...
        #begin
        zk = ZK('geotecheg.hopto.org') # already tested
        conn = zk.connect()
    ...
    def test_force_udp_connect(self, helper, socket):
        ...
        zk = ZK('geotecheg.hopto.org', force_udp=True)
        conn = zk.connect()
        socket.return_value.sendto.assert_called_with(codecs.decode('e80317fc00000000', 'hex'), ('geotecheg.hopto.org', 4370))
        conn.disconnect()
        socket.return_value.sendto.assert_called_with(codecs.decode('e903e6002ffb0100', 'hex'), ('geotecheg.hopto.org', 4370))
    ...
    def test_tcp_unauth(self, helper, socket):
        ...
        #begin
        zk = ZK('geotecheg.hopto.org', password=12)
    ...
    def test_tcp_auth(self, helper, socket):
        ...
        #begin
        zk = ZK('geotecheg.hopto.org', password=45)
        conn = zk.connect()
    ...
    def test_tcp_get_users_broken_data(self, helper, socket):
        ...
        #begin
        zk = ZK('geotecheg.hopto.org') #, verbose=True)
        conn = zk.connect()
        socket.return_value.send.assert_called_with(codecs.decode('5050827d08000000e80317fc00000000', 'hex'))
        users = conn.get_users()
        #print (users) #debug
